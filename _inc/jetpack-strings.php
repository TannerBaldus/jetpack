...
__( "There are unsaved settings in this tab that will be lost if you leave it. Proceed?", "jetpack" ), // _inc/client/main.jsx:59
...
__( "Performance", "jetpack" ), // _inc/client/at-a-glance/index.jsx:50
__( "Manage security on WordPress.com", "jetpack" ), // _inc/client/at-a-glance/index.jsx:40
__( "Security", "jetpack" ), // _inc/client/at-a-glance/index.jsx:35
__( "{{a}}Activate Monitor{{/a}} to receive notifications if your site goes down.", "jetpack" ), // _inc/client/at-a-glance/monitor.jsx:63
__( "Unavailable in Dev Mode.", "jetpack" ), // _inc/client/at-a-glance/monitor.jsx:62
__( "Jetpack is monitoring your site. If we think your site is down you will receive an email.", "jetpack" ), // _inc/client/at-a-glance/monitor.jsx:49
__( "Loading…", "jetpack" ), // _inc/client/at-a-glance/monitor.jsx:38
__( "Downtime Monitoring", "jetpack" ), // _inc/client/at-a-glance/monitor.jsx:25
__( "{{a}}Activate Photon{{/a}} to enhance the performance and speed of your images.", "jetpack" ), // _inc/client/at-a-glance/photon.jsx:45
__( "Unavailable in Dev Mode", "jetpack" ), // _inc/client/at-a-glance/photon.jsx:44
__( "Jetpack is improving and optimising your image speed.", "jetpack" ), // _inc/client/at-a-glance/photon.jsx:31
__( "Image Performance %(photon)s", "jetpack" ), // _inc/client/at-a-glance/photon.jsx:22
__( "{{a}}Activate Manage{{/a}} to turn on auto updates and manage your plugins from WordPress.com.", "jetpack" ), // _inc/client/at-a-glance/plugins.jsx:101
__( "All plugins are up-to-date. Awesome work!", "jetpack" ), // _inc/client/at-a-glance/plugins.jsx:100
...
__( "Loading…", "jetpack" ), // _inc/client/at-a-glance/plugins.jsx:49
__( "Plugin Updates", "jetpack" ), // _inc/client/at-a-glance/plugins.jsx:34
__( "{{a}}Activate Protect{{/a}} to keep your site protected from malicious login attempts.", "jetpack" ), // _inc/client/at-a-glance/protect.jsx:66
...
__( "Learn More", "jetpack" ), // _inc/client/security/index.jsx:120
__( "Pro", "jetpack" ), // _inc/client/security/index.jsx:83
__( "Unavailable in Dev Mode", "jetpack" ), // _inc/client/security/index.jsx:56
__( "Automatically backup your entire site.", "jetpack" ), // _inc/client/security/index.jsx:51
__( "Site Backups", "jetpack" ), // _inc/client/security/index.jsx:51
__( "State-of-the-art spam defense.", "jetpack" ), // _inc/client/security/index.jsx:50
__( "Automated, comprehensive protection from threats and attacks.", "jetpack" ), // _inc/client/security/index.jsx:47
__( "Security Scanning", "jetpack" ), // _inc/client/security/index.jsx:47
...
__( "Months", "jetpack" ), // _inc/client/at-a-glance/stats/index.jsx:196
__( "Weeks", "jetpack" ), // _inc/client/at-a-glance/stats/index.jsx:191
__( "Days", "jetpack" ), // _inc/client/at-a-glance/stats/index.jsx:186
__( "Activate Site Stats", "jetpack" ), // _inc/client/at-a-glance/stats/index.jsx:169
__( "{{a}}Activate Site Stats{{/a}} to see detailed stats, likes, followers, subscribers, and more! {{a1}}Learn More{{/a1}}", "jetpack" ), // _inc/client/at-a-glance/stats/index.jsx:154
__( "Unavailable in Dev Mode", "jetpack" ), // _inc/client/at-a-glance/stats/index.jsx:153
__( "Jetpack Stats Icon", "jetpack" ), // _inc/client/at-a-glance/stats/index.jsx:149
__( "Something happened while loading stats. Please try again later or {{a}}view your stats now on WordPress.com{{/a}}", "jetpack" ), // _inc/client/at-a-glance/stats/index.jsx:117
__( "Click to view detailed stats.", "jetpack" ), // _inc/client/at-a-glance/stats/index.jsx:91
__( "Views: %(numberOfViews)s", "jetpack" ), // _inc/client/at-a-glance/stats/index.jsx:89
__( "Week of %(date)s", "jetpack" ), // _inc/client/at-a-glance/stats/index.jsx:73
...
__( "News Sitemap: {{a}}%(url)s{{/a}}", "jetpack" ), // _inc/client/components/module-settings/index.jsx:794
__( "Sitemap: {{a}}%(url)s{{/a}}", "jetpack" ), // _inc/client/components/module-settings/index.jsx:784
__( "Search engines will find the sitemaps at these locations:", "jetpack" ), // _inc/client/components/module-settings/index.jsx:782
__( "Use Markdown for comments", "jetpack" ), // _inc/client/components/module-settings/index.jsx:763
__( "Add a phrase", "jetpack" ), // _inc/client/components/module-settings/index.jsx:735
__( "Ignored Phrases", "jetpack" ), // _inc/client/components/module-settings/index.jsx:731
__( "Redundant Phrases", "jetpack" ), // _inc/client/components/module-settings/index.jsx:727
__( "Phrases to Avoid", "jetpack" ), // _inc/client/components/module-settings/index.jsx:723
__( "Passive Voice", "jetpack" ), // _inc/client/components/module-settings/index.jsx:719
__( "Jargon", "jetpack" ), // _inc/client/components/module-settings/index.jsx:715
__( "Hidden Verbs", "jetpack" ), // _inc/client/components/module-settings/index.jsx:711
__( "Double Negatives", "jetpack" ), // _inc/client/components/module-settings/index.jsx:707
__( "Diacritical Marks", "jetpack" ), // _inc/client/components/module-settings/index.jsx:703
__( "Complex Phrases", "jetpack" ), // _inc/client/components/module-settings/index.jsx:699
__( "Clichés", "jetpack" ), // _inc/client/components/module-settings/index.jsx:695
__( "Bias Language", "jetpack" ), // _inc/client/components/module-settings/index.jsx:691
__( "Enable proofreading for the following grammar and style rules: ", "jetpack" ), // _inc/client/components/module-settings/index.jsx:687
__( "English Options", "jetpack" ), // _inc/client/components/module-settings/index.jsx:686
__( "Use automatically detected language to proofread posts and pages", "jetpack" ), // _inc/client/components/module-settings/index.jsx:683
__( "The proofreader supports English, French, German, Portuguese and Spanish.", "jetpack" ), // _inc/client/components/module-settings/index.jsx:678
__( "Automatic Language Detection", "jetpack" ), // _inc/client/components/module-settings/index.jsx:676
__( "A post or page is updated", "jetpack" ), // _inc/client/components/module-settings/index.jsx:673
__( "A post or page is first published", "jetpack" ), // _inc/client/components/module-settings/index.jsx:669
__( "Automatically proofread content when: ", "jetpack" ), // _inc/client/components/module-settings/index.jsx:665
__( "Proofreading", "jetpack" ), // _inc/client/components/module-settings/index.jsx:664
__( "Enable Testimonials for this site.", "jetpack" ), // _inc/client/components/module-settings/index.jsx:642
__( "Enable Portfolio Projects for this site.", "jetpack" ), // _inc/client/components/module-settings/index.jsx:637
__( "Configure Testimonials", "jetpack" ), // _inc/client/components/module-settings/index.jsx:628
__( "Configure Portfolios", "jetpack" ), // _inc/client/components/module-settings/index.jsx:618
__( "Link your account to WordPress.com to start using this feature.", "jetpack" ), // _inc/client/components/module-settings/index.jsx:596
__( "Regenerate address", "jetpack" ), // _inc/client/components/module-settings/index.jsx:587
__( "Highlight and copy the following text to your clipboard:", "jetpack" ), // _inc/client/components/module-settings/index.jsx:583
__( "Copied!", "jetpack" ), // _inc/client/components/module-settings/index.jsx:582
_x( "Copy", "verb", "jetpack" ), // _inc/client/components/module-settings/index.jsx:581
__( "Email Address", "jetpack" ), // _inc/client/components/module-settings/index.jsx:578
__( "Display all your gallery pictures in a cool mosaic", "jetpack" ), // _inc/client/components/module-settings/index.jsx:545
__( "Excerpts", "jetpack" ), // _inc/client/components/module-settings/index.jsx:541
...
__( "View people's profiles when you mouse over their Gravatars", "jetpack" ), // _inc/client/components/module-settings/index.jsx:439
__( "Show a promo for the WordPress mobile apps in the footer of the mobile theme", "jetpack" ), // _inc/client/components/module-settings/index.jsx:421
__( "Mobile Promos", "jetpack" ), // _inc/client/components/module-settings/index.jsx:417
__( "Featured Images", "jetpack" ), // _inc/client/components/module-settings/index.jsx:410
__( "Excerpts", "jetpack" ), // _inc/client/components/module-settings/index.jsx:403
__( "Track each infinite Scroll post load as a page view in Google Analytics", "jetpack" ), // _inc/client/components/module-settings/index.jsx:385
__( "Scroll infinitely (Shows 7 posts on each load)", "jetpack" ), // _inc/client/components/module-settings/index.jsx:381
__( "Background Color", "jetpack" ), // _inc/client/components/module-settings/index.jsx:356
__( "Show photo metadata (Exif) in carousel, when available", "jetpack" ), // _inc/client/components/module-settings/index.jsx:353
__( "Mobile Promos", "jetpack" ), // _inc/client/components/module-settings/index.jsx:349
__( "Require Two-Step Authentication", "jetpack" ), // _inc/client/components/module-settings/index.jsx:331
__( "Match By Email", "jetpack" ), // _inc/client/components/module-settings/index.jsx:327
__( "{{a}}Edit{{/a}}", "jetpack" ), // _inc/client/components/module-settings/index.jsx:300
__( "Emails will be sent to ", "jetpack" ), // _inc/client/components/module-settings/index.jsx:297
__( "Receive Monitor Email Notifications", "jetpack" ), // _inc/client/components/module-settings/index.jsx:296
__( "IPv4 and IPv6 are acceptable. {{br/}} To specify a range, enter the low value and high value separated by a dash. Example: 12.12.12.1-12.12.12.100", "jetpack" ), // _inc/client/components/module-settings/index.jsx:271
__( "Make sure to add your most frequently used IP addresses as they can change between your home, office or other locations. Removing an IP address from the list below will remove it from your whitelist.", "jetpack" ), // _inc/client/components/module-settings/index.jsx:262
__( "Whitelisting an IP address prevents it from ever being blocked by Jetpack.", "jetpack" ), // _inc/client/components/module-settings/index.jsx:261
__( "Whitelist Management", "jetpack" ), // _inc/client/components/module-settings/index.jsx:260
__( "Your Current IP: %(ip)s", "jetpack" ), // _inc/client/components/module-settings/index.jsx:254
__( "Report Visibility: Select the roles that will be able to view stats reports", "jetpack" ), // _inc/client/components/module-settings/index.jsx:233
__( "Registered Users: Count the page views of registered users who are logged in", "jetpack" ), // _inc/client/components/module-settings/index.jsx:226
__( "Hide the stats smiley face image. The image helps collect stats but should still work when hidden.", "jetpack" ), // _inc/client/components/module-settings/index.jsx:223
__( "Smiley", "jetpack" ), // _inc/client/components/module-settings/index.jsx:219
__( "Put a chart showing 48 hours of views in the admin bar", "jetpack" ), // _inc/client/components/module-settings/index.jsx:216
__( "Admin Bar", "jetpack" ), // _inc/client/components/module-settings/index.jsx:212
